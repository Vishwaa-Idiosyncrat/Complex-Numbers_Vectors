createVector.prototype.addVectors = function(){
  ...
  object.div.append('text').html(`\\( ${symbol_r} = ${symbol_1} + ${symbol_2} \\)<br>`).styles({ 'font-size': object.font_size_normal });
  object.div.append('text').html(`\\( ${symbol_r}_r = ${symbol_1}_r + ${symbol_2}_r \\)<br>`);
  object.div.append('text').html(`\\( ${symbol_r}_θ = ${symbol_1}_θ + ${symbol_2}_θ \\)`);
